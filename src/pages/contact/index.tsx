      ...
      <main className="py-16 sm:py-24">
        <div className="mx-auto max-w-4xl px-6 md:px-8">
          ...
          <ScrollReveal delay={100}>
            <div className="glass-card p-8 sm:p-12 text-center mb-12 transition-all duration-300 hover:border-primary/50">
          ...
          <div className="grid gap-6 sm:grid-cols-3">
            ...
            <ScrollReveal delay={200}>
              <a
                ...
                className="glass-card p-6 transition-all duration-300 hover:border-primary/50 text-center group block h-full"
              >
