      ...
      <main className="py-16 sm:py-24">
        <div className="mx-auto max-w-4xl px-6 md:px-8">
          ...
          <ScrollReveal delay={100}>
            <Card className="p-8 sm:p-12 text-center mb-12 transition-all duration-300 hover:border-primary/50">
              <CardContent>
              ...
              <Button href="https://cal.com/reifydb/30min">
                Schedule a Call
              </Button>
              </CardContent>
            </Card>
          ...
          <div className="grid gap-6 sm:grid-cols-3">
            ...
            <ScrollReveal delay={200}>
              <a href="mailto:founder@reifydb.com" className="block h-full">
                <Card className="h-full text-center transition-all duration-300 hover:border-primary/50">
