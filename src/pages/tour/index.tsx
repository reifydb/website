...
export function TourPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      {/* Progress header */}
      <div className="border-b border-dashed border-white/15 bg-bg-secondary sticky top-[60px] z-30">
      ...
      {/* Navigation bar */}
      <div className="border-t border-dashed border-white/15 bg-bg-secondary sticky bottom-0 z-30">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 py-4 flex justify-between items-center">
          <button
            onClick={() => goToStep(currentStep - 1)}
            disabled={currentStep === 1}
            className="font-mono text-sm border border-white/20 text-text-secondary hover:border-primary hover:text-primary px-4 py-2 transition-colors disabled:opacity-30 disabled:cursor-not-allowed"
          >
            [&lt; prev]
          </button>
