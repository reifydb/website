...
export const scriptingDropTableExample: CodeExample = {
...
export const scriptingDropIfExistsExample: CodeExample = {
...
export const scriptingSchemaDropExamples: CodeExample[] = [
  scriptingDropTableExample,
  scriptingDropIfExistsExample,
];
