...
function DraftBanner() {
  return (
    <div className="sticky top-[60px] z-30 -mx-4 sm:-mx-6 md:-mx-8 lg:-ml-12 -mt-6 sm:-mt-8 mb-6 bg-amber-100 border-b-2 border-dashed border-amber-400 px-4 py-2">
      <div className="flex items-center gap-2 text-amber-800 text-sm font-mono">
