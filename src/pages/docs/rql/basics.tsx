    ...
    <Layout>
      <div className="space-y-8">
        ...
        <section>
          ...
          <p className="text-text-secondary mb-4">
            The <code className="bg-bg-tertiary border border-border-default px-1.5 py-0.5 text-xs font-mono">from</code> transform tells RQL where your data lives.
          </p>
        ...
        {/* <section>
          ...
          <p className="text-text-secondary mb-4">
            Use <code className="bg-bg-tertiary border border-border-default px-1.5 py-0.5 text-xs font-mono">#</code> for single-line comments:
          </p>
          <ExecutableSnippet
          ...
          <p className="text-text-secondary mt-4 mb-4">
            Use <code className="bg-bg-tertiary border border-border-default px-1.5 py-0.5 text-xs font-mono">/*</code> for block comments:
          </p>
          <ExecutableSnippet
        ...
        <section>
          ...
          <div className="overflow-x-auto">
            <table className="w-full border-2 border-border-default text-sm overflow-hidden">
              <thead>
                <tr className="bg-bg-elevated">
                  <th className="text-left px-4 py-3 border-b border-border-default font-semibold">Type</th>
                  <th className="text-left px-4 py-3 border-b border-border-default font-semibold">Example</th>
                </tr>
              </thead>
              <tbody className="bg-bg-tertiary">
                <tr>
                  <td className="px-4 py-3 border-b border-border-default">Strings</td>
                  <td className="px-4 py-3 border-b border-border-default font-mono text-xs text-text-secondary">"hello" or 'hello'</td>
                </tr>
                <tr>
                  <td className="px-4 py-3 border-b border-border-default">Numbers</td>
                  <td className="px-4 py-3 border-b border-border-default font-mono text-xs text-text-secondary">42, 3.14, 1_000_000</td>
                </tr>
                <tr>
                  <td className="px-4 py-3 border-b border-border-default">Booleans</td>
                  <td className="px-4 py-3 border-b border-border-default font-mono text-xs text-text-secondary">true, false</td>
                </tr>
                <tr>
