import { dateMonthInlineExample as dateMonthInline } from './month.examples';
    ...
    <Layout>
      <div className="space-y-8">
            ...
            <table className="w-full">
              ...
              <tbody>
                <tr className="border-t-2 border-border-default">
                  ...
                  <td className="p-2 sm:p-3">The date to extract the month from</td>
                </tr>
              </tbody>
            </table>
          </div>
        ...
        <section>
          ...
          <ExecutableSnippet title={dateMonthInline.title} initialCode={dateMonthInline.code} />
        </section>
