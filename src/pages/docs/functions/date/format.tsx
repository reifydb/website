import { dateFormatInlineExample as dateFormatInline } from './format.examples';
    ...
    <Layout>
      <div className="space-y-8">
        ...
        <section>
          ...
          <ExecutableSnippet title={dateFormatInline.title} initialCode={dateFormatInline.code} />
        </section>
