import { dateIsLeapYearInlineExample as dateIsLeapYearInline } from './is_leap_year.examples';
    ...
    <Layout>
      <div className="space-y-8">
        <div>
          ...
          <h1 className="text-3xl sm:text-4xl font-black tracking-tight mb-4">date::is_leap_year</h1>
          <p className="text-lg text-text-secondary leading-relaxed">Check if a date falls in a leap year.</p>
        </div>
        <section><h2 className="text-2xl font-black tracking-tight mb-4">Syntax</h2><RqlCodeBlock code={`date::is_leap_year(date_value)`} /></section>
        <section>
          ...
          <div className="border-2 border-border-default overflow-x-auto"><table className="w-full">
            ...
            <tbody><tr className="border-t-2 border-border-default"><td className="p-2 sm:p-3"><code>date_value</code></td><td className="p-2 sm:p-3">Date</td><td className="p-2 sm:p-3">The date to check for a leap year.</td></tr></tbody>
          </table></div>
        </section>
