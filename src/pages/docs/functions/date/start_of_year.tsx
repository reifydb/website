      ...
      <div className="space-y-8">
        ...
        <section>
          ...
          <div className="border border-border-light overflow-x-auto rounded-md"><table className="w-full">
            ...
            <tbody><tr className="border-t border-border-light"><td className="p-2 sm:p-3"><code>date_value</code></td><td className="p-2 sm:p-3">Date</td><td className="p-2 sm:p-3">The date to get the first day of the year for.</td></tr></tbody>
          </table></div>
        </section>
