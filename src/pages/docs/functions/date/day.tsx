import { dateDayInlineExample as dateDayInline } from './day.examples';
    ...
    <Layout>
      <div className="space-y-8">
            ...
            <table className="w-full">
              ...
              <tbody>
                <tr className="border-t border-border-light">
                  ...
                  <td className="p-2 sm:p-3">The date to extract the day from</td>
                </tr>
              </tbody>
            </table>
          </div>
        ...
        <section>
          ...
          <ExecutableSnippet title={dateDayInline.title} initialCode={dateDayInline.code} />
        </section>
