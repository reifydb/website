      ...
      <div className="space-y-8">
        ...
        <section>
          ...
          <div className="border border-border-light overflow-x-auto rounded-md"><table className="w-full">
            ...
            <tbody>
              <tr className="border-t border-border-light"><td className="p-2 sm:p-3"><code>date_value</code></td><td className="p-2 sm:p-3">Date</td><td className="p-2 sm:p-3">The date to truncate.</td></tr>
              <tr className="border-t border-border-light"><td className="p-2 sm:p-3"><code>precision</code></td><td className="p-2 sm:p-3">Utf8</td><td className="p-2 sm:p-3">The precision to truncate to (e.g., month, year).</td></tr>
            </tbody>
          </table></div>
        </section>
        ...
        <section>
          ...
          <ExecutableSnippet title={dateTruncInline.title} initialCode={dateTruncInline.code} />
        </section>
