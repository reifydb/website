import { dateNewInlineExample as dateNewInline } from './new.examples';
    ...
    <Layout>
      <div className="space-y-8">
        <div>
          ...
          <h1 className="text-3xl sm:text-4xl font-black tracking-tight mb-4">date::new</h1>
          <p className="text-lg text-text-secondary leading-relaxed">Create a new date from year, month, and day components.</p>
        </div>
        <section><h2 className="text-2xl font-black tracking-tight mb-4">Syntax</h2><RqlCodeBlock code={`date::new(year, month, day)`} /></section>
        <section>
          ...
          <div className="border-2 border-border-default overflow-x-auto"><table className="w-full">
            ...
            <tbody>
              <tr className="border-t-2 border-border-default"><td className="p-2 sm:p-3"><code>year</code></td><td className="p-2 sm:p-3">Integer</td><td className="p-2 sm:p-3">The year component.</td></tr>
              <tr className="border-t-2 border-border-default"><td className="p-2 sm:p-3"><code>month</code></td><td className="p-2 sm:p-3">Integer</td><td className="p-2 sm:p-3">The month component.</td></tr>
              <tr className="border-t-2 border-border-default"><td className="p-2 sm:p-3"><code>day</code></td><td className="p-2 sm:p-3">Integer</td><td className="p-2 sm:p-3">The day component.</td></tr>
            </tbody>
          </table></div>
        </section>
