...
export function DurationWeeksPage() {
  return (
    <Layout>
      <div className="space-y-8">
        <div>
          ...
          <h1 className="text-3xl sm:text-4xl font-black tracking-tight mb-4">duration::weeks</h1>
          <p className="text-lg text-text-secondary leading-relaxed">Create a duration of the specified number of weeks.</p>
          <p className="text-text-muted text-sm mt-2">Alias: <code>duration::week</code></p>
        </div>
        ...
        <section>
          ...
          <ExecutableSnippet title={durationWeeks.title} initialCode={durationWeeks.code} />
        </section>
