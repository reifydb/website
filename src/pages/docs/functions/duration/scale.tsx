import { durationScaleExample as durationScale } from './scale.examples';
      ...
      <div className="space-y-8">
        ...
        <section>
          ...
          <div className="border border-border-light overflow-x-auto rounded-md"><table className="w-full">
            ...
            <tbody>
              <tr className="border-t border-border-light"><td className="p-2 sm:p-3"><code>duration</code></td><td className="p-2 sm:p-3">Duration</td><td className="p-2 sm:p-3">The duration to scale.</td></tr>
              <tr className="border-t border-border-light"><td className="p-2 sm:p-3"><code>factor</code></td><td className="p-2 sm:p-3">Number</td><td className="p-2 sm:p-3">The numeric factor to scale by.</td></tr>
            </tbody>
          </table></div>
        </section>
        ...
        <section>
          ...
          <ExecutableSnippet title={durationScale.title} initialCode={durationScale.code} />
        </section>
