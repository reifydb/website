      ...
      <div className="space-y-8">
        ...
        <section>
          ...
          <div className="border border-border-light overflow-x-auto rounded-md"><table className="w-full">
            ...
            <tbody>
              <tr className="border-t border-border-light"><td className="p-2 sm:p-3"><Link to="/docs/functions/duration/years" className="text-primary-color hover:underline">duration::years</Link></td><td className="p-2 sm:p-3">Create a duration of the specified number of years.</td></tr>
              <tr className="border-t border-border-light"><td className="p-2 sm:p-3"><Link to="/docs/functions/duration/months" className="text-primary-color hover:underline">duration::months</Link></td><td className="p-2 sm:p-3">Create a duration of the specified number of months.</td></tr>
              <tr className="border-t border-border-light"><td className="p-2 sm:p-3"><Link to="/docs/functions/duration/weeks" className="text-primary-color hover:underline">duration::weeks</Link></td><td className="p-2 sm:p-3">Create a duration of the specified number of weeks.</td></tr>
              <tr className="border-t border-border-light"><td className="p-2 sm:p-3"><Link to="/docs/functions/duration/days" className="text-primary-color hover:underline">duration::days</Link></td><td className="p-2 sm:p-3">Create a duration of the specified number of days.</td></tr>
              <tr className="border-t border-border-light"><td className="p-2 sm:p-3"><Link to="/docs/functions/duration/hours" className="text-primary-color hover:underline">duration::hours</Link></td><td className="p-2 sm:p-3">Create a duration of the specified number of hours.</td></tr>
              <tr className="border-t border-border-light"><td className="p-2 sm:p-3"><Link to="/docs/functions/duration/minutes" className="text-primary-color hover:underline">duration::minutes</Link></td><td className="p-2 sm:p-3">Create a duration of the specified number of minutes.</td></tr>
              <tr className="border-t border-border-light"><td className="p-2 sm:p-3"><Link to="/docs/functions/duration/seconds" className="text-primary-color hover:underline">duration::seconds</Link></td><td className="p-2 sm:p-3">Create a duration of the specified number of seconds.</td></tr>
              <tr className="border-t border-border-light"><td className="p-2 sm:p-3"><Link to="/docs/functions/duration/millis" className="text-primary-color hover:underline">duration::millis</Link></td><td className="p-2 sm:p-3">Create a duration of the specified number of milliseconds.</td></tr>
              <tr className="border-t border-border-light"><td className="p-2 sm:p-3"><Link to="/docs/functions/duration/get_months" className="text-primary-color hover:underline">duration::get_months</Link></td><td className="p-2 sm:p-3">Get the months component of a duration.</td></tr>
              <tr className="border-t border-border-light"><td className="p-2 sm:p-3"><Link to="/docs/functions/duration/get_days" className="text-primary-color hover:underline">duration::get_days</Link></td><td className="p-2 sm:p-3">Get the days component of a duration.</td></tr>
              <tr className="border-t border-border-light"><td className="p-2 sm:p-3"><Link to="/docs/functions/duration/get_nanos" className="text-primary-color hover:underline">duration::get_nanos</Link></td><td className="p-2 sm:p-3">Get the nanoseconds component of a duration.</td></tr>
              <tr className="border-t border-border-light"><td className="p-2 sm:p-3"><Link to="/docs/functions/duration/add" className="text-primary-color hover:underline">duration::add</Link></td><td className="p-2 sm:p-3">Add two durations together.</td></tr>
              <tr className="border-t border-border-light"><td className="p-2 sm:p-3"><Link to="/docs/functions/duration/subtract" className="text-primary-color hover:underline">duration::subtract</Link></td><td className="p-2 sm:p-3">Subtract one duration from another.</td></tr>
              <tr className="border-t border-border-light"><td className="p-2 sm:p-3"><Link to="/docs/functions/duration/negate" className="text-primary-color hover:underline">duration::negate</Link></td><td className="p-2 sm:p-3">Negate a duration (flip its sign).</td></tr>
              <tr className="border-t border-border-light"><td className="p-2 sm:p-3"><Link to="/docs/functions/duration/scale" className="text-primary-color hover:underline">duration::scale</Link></td><td className="p-2 sm:p-3">Scale a duration by a numeric factor.</td></tr>
              <tr className="border-t border-border-light"><td className="p-2 sm:p-3"><Link to="/docs/functions/duration/trunc" className="text-primary-color hover:underline">duration::trunc</Link></td><td className="p-2 sm:p-3">Truncate a duration to a specified precision.</td></tr>
              <tr className="border-t border-border-light"><td className="p-2 sm:p-3"><Link to="/docs/functions/duration/format" className="text-primary-color hover:underline">duration::format</Link></td><td className="p-2 sm:p-3">Format a duration as a human-readable string.</td></tr>
            </tbody>
          </table></div>
        </section>
      </div>
