    ...
    <Layout>
      <div className="space-y-8">
        <div>
          ...
          <h1 className="text-3xl sm:text-4xl font-black tracking-tight mb-4">duration::millis</h1>
          <p className="text-lg text-text-secondary leading-relaxed">Create a duration of the specified number of milliseconds.</p>
          <p className="text-text-muted text-sm mt-2">Alias: <code>duration::milli</code></p>
        </div>
        <section><h2 className="text-2xl font-black tracking-tight mb-4">Syntax</h2><RqlCodeBlock code={`duration::millis(count)`} /></section>
        <section>
          ...
          <div className="border-2 border-border-default overflow-x-auto"><table className="w-full">
            ...
            <tbody><tr className="border-t-2 border-border-default"><td className="p-2 sm:p-3"><code>count</code></td><td className="p-2 sm:p-3">Integer</td><td className="p-2 sm:p-3">The number of milliseconds for the duration.</td></tr></tbody>
          </table></div>
        </section>
