      ...
      <div className="space-y-8">
        ...
        <section>
          ...
          <div className="border border-border-light overflow-x-auto rounded-md"><table className="w-full">
            ...
            <tbody><tr className="border-t border-border-light"><td className="p-2 sm:p-3"><code>count</code></td><td className="p-2 sm:p-3">Integer</td><td className="p-2 sm:p-3">The number of milliseconds for the duration.</td></tr></tbody>
          </table></div>
        </section>
