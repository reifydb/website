    ...
    <Layout>
      <div className="space-y-8">
        <div>
          ...
          <h1 className="text-3xl sm:text-4xl font-black tracking-tight mb-4">datetime::add</h1>
          <p className="text-lg text-text-secondary leading-relaxed">Add a duration to a datetime.</p>
        </div>
        <section>
          <h2 className="text-2xl font-black tracking-tight mb-4">Syntax</h2>
          <RqlCodeBlock code={`datetime::add(datetime_value, duration)`} />
        </section>
        <section>
            ...
            <table className="w-full">
              ...
              <tbody>
                <tr className="border-t-2 border-border-default">
                  ...
                  <td className="p-2 sm:p-3">The datetime to add the duration to</td>
                </tr>
                <tr className="border-t-2 border-border-default">
                  <td className="p-2 sm:p-3"><code>duration</code></td>
                  <td className="p-2 sm:p-3">Duration</td>
                  <td className="p-2 sm:p-3">The duration to add</td>
                </tr>
              </tbody>
            </table>
          </div>
        ...
        <section>
          ...
          <p className="text-text-secondary">Returns a Datetime representing the result of adding the duration to the datetime.</p>
        </section>
        <section>
        ...
        <section>
          ...
          <div className="flex gap-3 flex-wrap">
            <Link to="/docs/functions/datetime/subtract" className="border-2 border-border-default px-3 py-1 hover:bg-bg-tertiary transition-colors font-bold text-primary-color">datetime::subtract</Link>
