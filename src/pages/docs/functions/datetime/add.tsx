import { datetimeAddExample as datetimeAdd } from './add.examples';
      ...
      <div className="space-y-8">
        ...
        <section>
          ...
          <div className="flex gap-3 flex-wrap">
            <Link to="/docs/functions/datetime/subtract" className="text-primary-color hover:underline">datetime::subtract</Link>
