...
export function DatetimeDiffPage() {
  return (
    <Layout>
      <div className="space-y-8">
        <div>
          ...
          <h1 className="text-3xl sm:text-4xl font-black tracking-tight mb-4">datetime::diff</h1>
          <p className="text-lg text-text-secondary leading-relaxed">Calculate the difference between two datetimes.</p>
        </div>
        <section>
          <h2 className="text-2xl font-black tracking-tight mb-4">Syntax</h2>
          <RqlCodeBlock code={`datetime::diff(datetime_a, datetime_b)`} />
        </section>
        <section>
        ...
        <section>
          ...
          <p className="text-text-secondary">Returns a Duration representing the difference between the two datetimes.</p>
        </section>
        <section>
          <h2 className="text-2xl font-black tracking-tight mb-4">Examples</h2>
          <ExampleSnippet id="datetime-diff" />
        </section>
        <section>
