import { datetimeDayOfWeekExample as datetimeDayOfWeek } from './day_of_week.examples';
import { ExecutableSnippet } from '@/components/ui';
import { Link } from 'react-router-dom';
import { Layout } from '../../layout.tsx';
import { RqlCodeBlock } from '../../components';

export function DatetimeDayOfWeekPage() {
  return (
    <Layout>
      <div className="space-y-8">
        <div>
          ...
          <h1 className="text-3xl sm:text-4xl font-black tracking-tight mb-4">datetime::day_of_week</h1>
          <p className="text-lg text-text-secondary leading-relaxed">Get the day of the week (1=Monday, 7=Sunday) from a datetime.</p>
        </div>
        <section>
          <h2 className="text-2xl font-black tracking-tight mb-4">Syntax</h2>
          <RqlCodeBlock code={`datetime::day_of_week(datetime_value)`} />
        </section>
        <section>
            ...
            <table className="w-full">
              ...
              <tbody>
                <tr className="border-t border-border-light">
                  ...
                  <td className="p-2 sm:p-3">The datetime to get the day of the week from</td>
                </tr>
              </tbody>
            </table>
          </div>
        ...
        <section>
          ...
          <p className="text-text-secondary">Returns an integer representing the day of the week (1=Monday, 7=Sunday).</p>
        </section>
        <section>
          <h2 className="text-2xl font-black tracking-tight mb-4">Examples</h2>
          <ExecutableSnippet title={datetimeDayOfWeek.title} initialCode={datetimeDayOfWeek.code} />
        </section>
        <section>
