...
export function DatetimeEpochPage() {
  return (
    <Layout>
      <div className="space-y-8">
        <div>
          ...
          <h1 className="text-3xl sm:text-4xl font-black tracking-tight mb-4">datetime::epoch</h1>
          <p className="text-lg text-text-secondary leading-relaxed">Get the Unix epoch timestamp in seconds from a datetime.</p>
        </div>
        <section>
          <h2 className="text-2xl font-black tracking-tight mb-4">Syntax</h2>
          <RqlCodeBlock code={`datetime::epoch(datetime_value)`} />
        </section>
        <section>
            ...
            <table className="w-full">
              ...
              <tbody>
                <tr className="border-t-2 border-border-default">
                  ...
                  <td className="p-2 sm:p-3">The datetime to convert to epoch seconds</td>
                </tr>
              </tbody>
            </table>
          </div>
        ...
        <section>
          ...
          <p className="text-text-secondary">Returns an integer representing the number of seconds since the Unix epoch.</p>
        </section>
        <section>
          <h2 className="text-2xl font-black tracking-tight mb-4">Examples</h2>
          <ExampleSnippet id="datetime-epoch" />
        </section>
        <section>
