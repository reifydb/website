import { datetimeMinuteExample as datetimeMinute } from './minute.examples';
import { ExecutableSnippet } from '@/components/ui';
import { Link } from 'react-router-dom';
import { Layout } from '../../layout.tsx';
import { RqlCodeBlock } from '../../components';

export function DatetimeMinutePage() {
  return (
    <Layout>
      <div className="space-y-8">
        <div>
          ...
          <h1 className="text-3xl sm:text-4xl font-black tracking-tight mb-4">datetime::minute</h1>
          <p className="text-lg text-text-secondary leading-relaxed">Extract the minute (0-59) from a datetime.</p>
        </div>
        <section>
          <h2 className="text-2xl font-black tracking-tight mb-4">Syntax</h2>
          <RqlCodeBlock code={`datetime::minute(datetime_value)`} />
        </section>
        <section>
            ...
            <table className="w-full">
              ...
              <tbody>
                <tr className="border-t-2 border-border-default">
                  ...
                  <td className="p-2 sm:p-3">The datetime to extract the minute from</td>
                </tr>
              </tbody>
            </table>
          </div>
        ...
        <section>
          ...
          <p className="text-text-secondary">Returns an integer representing the minute (0-59).</p>
        </section>
        <section>
          <h2 className="text-2xl font-black tracking-tight mb-4">Examples</h2>
          <ExecutableSnippet title={datetimeMinute.title} initialCode={datetimeMinute.code} />
        </section>
        <section>
