import { datetimeFromEpochExample as datetimeFromEpoch } from './from_epoch.examples';
    ...
    <Layout>
      <div className="space-y-8">
        ...
        <section>
          ...
          <ExecutableSnippet title={datetimeFromEpoch.title} initialCode={datetimeFromEpoch.code} />
        </section>
        <section>
