import { datetimeDayOfYearExample as datetimeDayOfYear } from './day_of_year.examples';
    ...
    <Layout>
      <div className="space-y-8">
        ...
        <section>
          ...
          <ExecutableSnippet title={datetimeDayOfYear.title} initialCode={datetimeDayOfYear.code} />
        </section>
        <section>
