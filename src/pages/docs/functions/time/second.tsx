      ...
      <div className="space-y-8">
        ...
        <section>
          ...
          <div className="border border-border-light overflow-x-auto rounded-md"><table className="w-full">
            ...
            <tbody><tr className="border-t border-border-light"><td className="p-2 sm:p-3"><code>time_value</code></td><td className="p-2 sm:p-3">Time</td><td className="p-2 sm:p-3">The time value to extract the second from</td></tr></tbody>
          </table></div>
        </section>
        ...
        <section>
          ...
          <ExecutableSnippet title={timeSecondExample.title} initialCode={timeSecondExample.code} />
        </section>
