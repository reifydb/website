      ...
      <div className="space-y-8">
        ...
        <section>
          ...
          <div className="border border-border-light overflow-x-auto rounded-md"><table className="w-full">
            ...
            <tbody>
              <tr className="border-t border-border-light"><td className="p-2 sm:p-3"><Link to="/docs/functions/time/hour" className="text-primary-color hover:underline font-semibold">time::hour</Link></td><td className="p-2 sm:p-3 text-text-secondary">Extract the hour (0-23) from a time value.</td></tr>
              <tr className="border-t border-border-light"><td className="p-2 sm:p-3"><Link to="/docs/functions/time/minute" className="text-primary-color hover:underline font-semibold">time::minute</Link></td><td className="p-2 sm:p-3 text-text-secondary">Extract the minute (0-59) from a time value.</td></tr>
              <tr className="border-t border-border-light"><td className="p-2 sm:p-3"><Link to="/docs/functions/time/second" className="text-primary-color hover:underline font-semibold">time::second</Link></td><td className="p-2 sm:p-3 text-text-secondary">Extract the second (0-59) from a time value.</td></tr>
              <tr className="border-t border-border-light"><td className="p-2 sm:p-3"><Link to="/docs/functions/time/nanosecond" className="text-primary-color hover:underline font-semibold">time::nanosecond</Link></td><td className="p-2 sm:p-3 text-text-secondary">Extract the nanosecond component from a time value.</td></tr>
              <tr className="border-t border-border-light"><td className="p-2 sm:p-3"><Link to="/docs/functions/time/new" className="text-primary-color hover:underline font-semibold">time::new</Link></td><td className="p-2 sm:p-3 text-text-secondary">Create a new time from hour, minute, and second components.</td></tr>
              <tr className="border-t border-border-light"><td className="p-2 sm:p-3"><Link to="/docs/functions/time/now" className="text-primary-color hover:underline font-semibold">time::now</Link></td><td className="p-2 sm:p-3 text-text-secondary">Get the current time of day.</td></tr>
              <tr className="border-t border-border-light"><td className="p-2 sm:p-3"><Link to="/docs/functions/time/add" className="text-primary-color hover:underline font-semibold">time::add</Link></td><td className="p-2 sm:p-3 text-text-secondary">Add a duration to a time value.</td></tr>
              <tr className="border-t border-border-light"><td className="p-2 sm:p-3"><Link to="/docs/functions/time/subtract" className="text-primary-color hover:underline font-semibold">time::subtract</Link></td><td className="p-2 sm:p-3 text-text-secondary">Subtract a duration from a time value.</td></tr>
              <tr className="border-t border-border-light"><td className="p-2 sm:p-3"><Link to="/docs/functions/time/diff" className="text-primary-color hover:underline font-semibold">time::diff</Link></td><td className="p-2 sm:p-3 text-text-secondary">Calculate the difference between two time values.</td></tr>
              <tr className="border-t border-border-light"><td className="p-2 sm:p-3"><Link to="/docs/functions/time/trunc" className="text-primary-color hover:underline font-semibold">time::trunc</Link></td><td className="p-2 sm:p-3 text-text-secondary">Truncate a time to a specified precision.</td></tr>
              <tr className="border-t border-border-light"><td className="p-2 sm:p-3"><Link to="/docs/functions/time/age" className="text-primary-color hover:underline font-semibold">time::age</Link></td><td className="p-2 sm:p-3 text-text-secondary">Calculate the elapsed duration from a time value until now.</td></tr>
              <tr className="border-t border-border-light"><td className="p-2 sm:p-3"><Link to="/docs/functions/time/format" className="text-primary-color hover:underline font-semibold">time::format</Link></td><td className="p-2 sm:p-3 text-text-secondary">Format a time value as a string.</td></tr>
            </tbody>
          </table></div>
        </section>
      </div>
