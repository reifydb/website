        ...
        <section>
          ...
          <div className="border border-border-light overflow-x-auto rounded-md"><table className="w-full">
            ...
            <tbody>
              ...
              <tr className="border-t border-border-light"><td className="p-2 sm:p-3"><code>duration</code></td><td className="p-2 sm:p-3">Duration</td><td className="p-2 sm:p-3">The duration to add</td></tr>
            </tbody>
          </table></div>
        </section>
