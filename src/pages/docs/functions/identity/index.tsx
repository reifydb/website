      ...
      <div className="space-y-8">
        ...
        <section>
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            <Link to="/docs/functions/identity/id" className="block border-2 border-border-default p-4 hover:bg-bg-tertiary transition-colors">
        ...
        <section>
          ...
          <div className="border-2 border-border-default overflow-x-auto"><table className="w-full">
            ...
            <tbody>
              <tr className="border-t-2 border-border-default"><td className="p-2 sm:p-3"><Link to="/docs/functions/identity/id" className="text-primary-color hover:underline font-mono">identity::id</Link></td><td className="p-2 sm:p-3">Get the unique identifier of a record</td></tr>
            </tbody>
          </table></div>
        </section>
      </div>
