    ...
    <Layout>
      <div className="space-y-8">
        <div>
          ...
          <h1 className="text-3xl sm:text-4xl font-black tracking-tight mb-4">blob::b64</h1>
          <p className="text-lg text-text-secondary leading-relaxed">Encode or decode a blob using Base64 encoding.</p>
        </div>
        <section>
          <h2 className="text-2xl font-black tracking-tight mb-4">Syntax</h2>
          <RqlCodeBlock code={`blob::b64(value)`} />
        </section>
        <section>
        ...
        <section>
          ...
          <p className="text-text-secondary">A Base64-encoded string when given a blob, or a blob when given a Base64 string.</p>
        </section>
        <section>
        ...
        <section>
          ...
          <div className="flex gap-3 flex-wrap">
            ...
            <Link to="/docs/functions/blob/b64url" className="border-2 border-border-default px-3 py-1.5 text-sm font-bold text-primary-color hover:bg-bg-tertiary transition-colors">blob::b64url</Link>
