    ...
    <Layout>
      <div className="space-y-8">
        <div>
          ...
          <h1 className="text-3xl sm:text-4xl font-black tracking-tight mb-4">blob::b58</h1>
          <p className="text-lg text-text-secondary leading-relaxed">Encode or decode a blob using Base58 encoding.</p>
        </div>
        <section>
          <h2 className="text-2xl font-black tracking-tight mb-4">Syntax</h2>
          <RqlCodeBlock code={`blob::b58(value)`} />
        </section>
        <section>
        ...
        <section>
          ...
          <p className="text-text-secondary">A Base58-encoded string when given a blob, or a blob when given a Base58 string.</p>
        </section>
        <section>
        ...
        <section>
          ...
          <div className="flex gap-3 flex-wrap">
            ...
            <Link to="/docs/functions/blob/utf8" className="text-primary-color hover:underline">blob::utf8</Link>
          </div>
        </section>
      </div>
    </Layout>
