...
export function BlobB64urlPage() {
  return (
    <Layout>
      <div className="space-y-8">
        <div>
          ...
          <h1 className="text-3xl sm:text-4xl font-black tracking-tight mb-4">blob::b64url</h1>
          <p className="text-lg text-text-secondary leading-relaxed">Encode or decode a blob using URL-safe Base64 encoding.</p>
        </div>
        <section>
          <h2 className="text-2xl font-black tracking-tight mb-4">Syntax</h2>
          <RqlCodeBlock code={`blob::b64url(value)`} />
        </section>
        <section>
        ...
        <section>
          ...
          <p className="text-text-secondary">A URL-safe Base64-encoded string when given a blob, or a blob when given a URL-safe Base64 string.</p>
        </section>
        <section>
          <h2 className="text-2xl font-black tracking-tight mb-4">Examples</h2>
          <ExecutableSnippet title={blobB64url.title} initialCode={blobB64url.code} />
        </section>
        <section>
