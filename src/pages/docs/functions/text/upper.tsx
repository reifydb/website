    ...
    <Layout>
      <div className="space-y-8">
            ...
            <table className="w-full">
              ...
              <tbody>
                <tr className="border-t-2 border-border-default">
                  ...
                  <td className="p-2 sm:p-3">The string to convert to uppercase</td>
                </tr>
              </tbody>
            </table>
          </div>
        ...
        <section>
          ...
          <ExecutableSnippet
            title={textUpperNames.title}
            initialCode={textUpperNames.code}
          />

          <h3 className="text-lg font-bold mt-6 mb-3">Uppercase code identifiers</h3>
          <ExecutableSnippet
            title={textUpperSku.title}
            initialCode={textUpperSku.code}
          />
        </section>
