        ...
        <section>
          ...
          <div className="border border-border-light overflow-x-auto rounded-md"><table className="w-full">
            ...
            <tbody>
              ...
              <tr className="border-t border-border-light"><td className="p-2 sm:p-3"><code>search</code></td><td className="p-2 sm:p-3">Utf8</td><td className="p-2 sm:p-3">The substring to find.</td></tr>
            </tbody>
          </table></div>
        </section>
