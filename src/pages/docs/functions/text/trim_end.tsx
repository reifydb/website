import { textTrimEndInlineExample as textTrimEndInline } from './trim_end.examples';
    ...
    <Layout>
      <div className="space-y-8">
        <div>
          ...
          <h1 className="text-3xl sm:text-4xl font-black tracking-tight mb-4">text::trim_end</h1>
          <p className="text-lg text-text-secondary leading-relaxed">Remove trailing whitespace from a string.</p>
        </div>
        <section><h2 className="text-2xl font-black tracking-tight mb-4">Syntax</h2><RqlCodeBlock code={`text::trim_end(value)`} /></section>
        <section>
          ...
          <div className="border-2 border-border-default overflow-x-auto"><table className="w-full">
            ...
            <tbody><tr className="border-t-2 border-border-default"><td className="p-2 sm:p-3"><code>value</code></td><td className="p-2 sm:p-3">Utf8</td><td className="p-2 sm:p-3">The string to trim trailing whitespace from.</td></tr></tbody>
          </table></div>
        </section>
