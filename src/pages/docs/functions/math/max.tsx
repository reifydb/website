import { mathMaxByCategoryExample as mathMaxByCategory, mathMaxMinTogetherExample as mathMaxMinTogether } from './max.examples';
    ...
    <Layout>
      <div className="space-y-8">
        ...
        <section>
          ...
          <RqlCodeBlock code={`math::max(value)`} />
        </section>
            ...
            <table className="w-full">
              ...
              <tbody>
                <tr className="border-t-2 border-border-default">
                  ...
                  <td className="p-2 sm:p-3">The numeric field to find the maximum of</td>
                </tr>
              </tbody>
            </table>
          </div>
        ...
        <section>
          ...
          <ExecutableSnippet
            title={mathMaxByCategory.title}
            initialCode={mathMaxByCategory.code}
          />

          <h3 className="text-lg font-bold mt-6 mb-3">Min and max together</h3>
          <ExecutableSnippet
            title={mathMaxMinTogether.title}
            initialCode={mathMaxMinTogether.code}
          />
        </section>
