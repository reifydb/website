import { mathGcdInlineExample as mathGcdInline } from './gcd.examples';
    ...
    <Layout>
      <div className="space-y-8">
        <div>
          ...
          <h1 className="text-3xl sm:text-4xl font-black tracking-tight mb-4">math::gcd</h1>
          <p className="text-lg text-text-secondary leading-relaxed">Compute the greatest common divisor of two integers.</p>
        </div>
        <section><h2 className="text-2xl font-black tracking-tight mb-4">Syntax</h2><RqlCodeBlock code={`math::gcd(a, b)`} /></section>
        <section>
          ...
          <div className="border border-border-light overflow-x-auto rounded-md"><table className="w-full">
            ...
            <tbody>
              <tr className="border-t border-border-light"><td className="p-2 sm:p-3"><code>a</code></td><td className="p-2 sm:p-3">Integer</td><td className="p-2 sm:p-3">The first integer</td></tr>
              <tr className="border-t border-border-light"><td className="p-2 sm:p-3"><code>b</code></td><td className="p-2 sm:p-3">Integer</td><td className="p-2 sm:p-3">The second integer</td></tr>
            </tbody>
          </table></div>
        </section>
