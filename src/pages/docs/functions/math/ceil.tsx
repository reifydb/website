import { mathCeilInlineExample as mathCeilInline } from './ceil.examples';
    ...
    <Layout>
      <div className="space-y-8">
        ...
        <section>
          ...
          <RqlCodeBlock code={`math::ceil(value)`} />
        </section>
            ...
            <table className="w-full">
              ...
              <tbody>
                <tr className="border-t border-border-light">
                  ...
                  <td className="p-2 sm:p-3">The number to round up</td>
                </tr>
              </tbody>
            </table>
          </div>
        ...
        <section>
          ...
          <ExecutableSnippet title={mathCeilInline.title} initialCode={mathCeilInline.code} />
        </section>
