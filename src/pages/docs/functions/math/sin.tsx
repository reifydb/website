import { mathSinInlineExample as mathSinInline } from './sin.examples';
    ...
    <Layout>
      <div className="space-y-8">
        <div>
          ...
          <h1 className="text-3xl sm:text-4xl font-black tracking-tight mb-4">math::sin</h1>
          <p className="text-lg text-text-secondary leading-relaxed">Compute the sine of an angle in radians.</p>
        </div>
        <section><h2 className="text-2xl font-black tracking-tight mb-4">Syntax</h2><RqlCodeBlock code={`math::sin(angle)`} /></section>
        <section>
