import { mathModInlineExample as mathModInline } from './mod.examples';
    ...
    <Layout>
      <div className="space-y-8">
        <div>
          ...
          <h1 className="text-3xl sm:text-4xl font-black tracking-tight mb-4">math::mod</h1>
          <p className="text-lg text-text-secondary leading-relaxed">Compute the modulo (remainder) of a division.</p>
        </div>
        <section><h2 className="text-2xl font-black tracking-tight mb-4">Syntax</h2><RqlCodeBlock code={`math::mod(a, b)`} /></section>
        <section>
          ...
          <div className="border-2 border-border-default overflow-x-auto"><table className="w-full">
            ...
            <tbody>
              <tr className="border-t-2 border-border-default"><td className="p-2 sm:p-3"><code>a</code></td><td className="p-2 sm:p-3">Number</td><td className="p-2 sm:p-3">The dividend</td></tr>
              <tr className="border-t-2 border-border-default"><td className="p-2 sm:p-3"><code>b</code></td><td className="p-2 sm:p-3">Number</td><td className="p-2 sm:p-3">The divisor</td></tr>
            </tbody>
          </table></div>
        </section>
