import { isTypeExample as isType } from './type.examples';
      ...
      <div className="space-y-8">
        ...
        <section>
          ...
          <div className="border border-border-light overflow-x-auto rounded-md"><table className="w-full">
            ...
            <tbody>
              <tr className="border-t border-border-light"><td className="p-2 sm:p-3"><code>value</code></td><td className="p-2 sm:p-3">Any</td><td className="p-2 sm:p-3">The value to check the type of</td></tr>
              <tr className="border-t border-border-light"><td className="p-2 sm:p-3"><code>type_name</code></td><td className="p-2 sm:p-3">Utf8</td><td className="p-2 sm:p-3">The name of the type to check against</td></tr>
            </tbody>
          </table></div>
        </section>
