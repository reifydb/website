import { isSomeExample as isSome } from './some.examples';
    ...
    <Layout>
      <div className="space-y-8">
        <div>
          ...
          <h1 className="text-3xl sm:text-4xl font-black tracking-tight mb-4">is::some</h1>
          <p className="text-lg text-text-secondary leading-relaxed">Check if a value is not none (has some value).</p>
        </div>
        <section><h2 className="text-2xl font-black tracking-tight mb-4">Syntax</h2><RqlCodeBlock code={`is::some(value)`} /></section>
        <section>
          ...
          <div className="border border-border-light overflow-x-auto rounded-md"><table className="w-full">
            ...
            <tbody><tr className="border-t border-border-light"><td className="p-2 sm:p-3"><code>value</code></td><td className="p-2 sm:p-3">Any</td><td className="p-2 sm:p-3">The value to check</td></tr></tbody>
          </table></div>
        </section>
