...
export const brutalistLightTheme: editor.IStandaloneThemeData = {
  ...
  inherit: true,
  rules: [
    { token: 'keyword', foreground: '1de5d2', fontStyle: 'bold' },
    ...
    { token: 'key', foreground: '1de5d2', fontStyle: 'bold' },
  ],
  colors: {
    'editor.background': '#FFFFFF',
    'editor.foreground': '#1A1A1A',
    'editor.lineHighlightBackground': '#F8F8F7',
    'editor.selectionBackground': '#1de5d240',
    'editorCursor.foreground': '#1de5d2',
...
export const brutalistDarkTheme: editor.IStandaloneThemeData = {
  ...
  colors: {
    ...
    'editor.selectionBackground': '#1de5d230',
    'editorCursor.foreground': '#1de5d2',
