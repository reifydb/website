    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1 flex items-center justify-center px-6 py-16">
        <div className="w-full max-w-2xl">
          {/* Terminal Window */}
          <div className="bg-code-bg border border-white/10 rounded-xl overflow-hidden">
            {/* macOS Chrome Header */}
            <div className="h-10 sm:h-12 bg-code-bg-elevated border-b border-white/10 flex items-center px-3 sm:px-4 gap-2">
              <div className="flex gap-1.5">
                <div className="w-3 h-3 rounded-full bg-status-error" />
                <div className="w-3 h-3 rounded-full bg-status-warning" />
                <div className="w-3 h-3 rounded-full bg-status-success" />
              </div>
              <span className="text-xs font-medium text-code-text-muted ml-2">reifydb@docs</span>
            </div>
          ...
          <div className="mt-8 text-center">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <a
                ...
                className="inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-primary to-accent-warm text-white font-semibold rounded-lg hover:shadow-[0_0_20px_rgba(20,184,166,0.4)] transition-all"
              >
                View on GitHub
              </a>
              <a
