    ...
    <div className="flex justify-center">
      <div className="font-mono text-[11px] sm:text-sm md:text-base w-full max-w-5xl">
        ...
        <div className="md:hidden">
          {/* Title */}
          <div className="border-2 border-dashed border-black/25 p-3 text-center">
          ...
          {/* Parameters */}
          <div className="border-2 border-dashed border-black/25 p-3">
          ...
          <div className="flex flex-col gap-3 mt-3">
            {/* Traditional */}
            <div className="border-2 border-dashed border-black/25 p-4">
          ...
          {/* Bottom callout */}
          <div className="border-2 border-dashed border-black/25 p-3 mt-3 text-center">
