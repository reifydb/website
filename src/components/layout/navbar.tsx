...
export function Navbar({ mobileExtra }: NavbarProps = {}) {
  ...
  return (
    <>
      <header className="sticky top-0 z-40 w-full bg-bg-primary border-b-2 border-border-default">
        <div className="flex h-[60px] w-full items-center justify-between px-4 sm:px-6 md:pl-8 md:pr-16">
          ...
          {/* Desktop Navigation */}
          <nav className="hidden lg:flex gap-0 font-mono text-xs items-center flex-1 justify-center">
            {/* Dropdown Menus */}
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="hidden lg:flex items-center gap-3">
              <a
                ...
                className="flex items-center px-3 py-2 rounded-none hover:bg-bg-tertiary transition-all"
              >
