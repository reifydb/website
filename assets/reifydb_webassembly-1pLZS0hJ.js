let F, W, P, Ae, Oe;
let __tla = (async () => {
  const z = "/assets/reifydb_webassembly_bg-CwR3BMmm.wasm", M = async (t = {}, e) => {
    let n;
  ...
  function lt(t, e) {
    _.__wasm_bindgen_func_elem_23035(t, e);
  }
  ...
  const d = await M({
    "./reifydb_webassembly_bg.js": {
      ...
      __wbg_setTimeout_49c6beea31ab145d: rt,
      __wbg_setInterval_0236835d1b362a11: nt,
      __wbg_clearInterval_852ceec2b0dc264d: G,
