let P, x, F;
let __tla = (async () => {
  const q = "/assets/reifydb_webassembly_bg-P9j3tTbu.wasm", z = async (t = {}, e) => {
    let n;
  ...
  F = class {
    ...
    constructor() {
      try {
        ...
        if (o) throw g(n);
        return this.__wbg_ptr = e >>> 0, D.register(this, this.__wbg_ptr, this), this;
      } finally {
        _.__wbindgen_add_to_stack_pointer(16);
      }
    }
  ...
  function bt(t, e) {
    const n = yt(t, e, _.__wasm_bindgen_func_elem_17033, ut);
    return u(n);
  }
  function gt(t, e) {
    const n = h(t, e);
  ...
  function ut(t, e) {
    _.__wasm_bindgen_func_elem_17067(t, e);
  }
  ...
  } : new FinalizationRegistry((t) => _.__wbg_jserror_free(t >>> 0, 1)), E = typeof FinalizationRegistry > "u" ? {
    register: () => {
    },
    unregister: () => {
    }
  } : new FinalizationRegistry((t) => _.__wbg_loginresult_free(t >>> 0, 1)), D = typeof FinalizationRegistry > "u" ? {
    register: () => {
    },
    unregister: () => {
    }
  ...
  function u(t) {
    j === y.length && y.push(y.length + 1);
    const e = j;
    return j = y[e], y[e] = t, e;
  }
  ...
  function p(t, e, n) {
    ...
    if (a !== o) {
      ...
      const c = T().subarray(r + a, r + o), b = S.encodeInto(t, c);
  ...
  const d = await z({
    "./reifydb_webassembly_bg.js": {
      ...
      __wbg_setTimeout_7605c0371cfee1cf: nt,
      __wbg_setInterval_18d7cbb39e64bd6e: _t,
      __wbg_clearInterval_277307769f387330: N,
  ...
  }, q), It = d.memory, kt = d.__wbg_loginresult_free, Wt = d.__wbg_wasmdb_free, Tt = d.loginresult_identity, jt = d.loginresult_token, St = d.wasmdb_admin, At = d.wasmdb_adminText, Ot = d.wasmdb_adminWithParams, Rt = d.wasmdb_command, Lt = d.wasmdb_commandText, Pt = d.wasmdb_commandWithParams, Ft = d.wasmdb_loginWithPassword, Et = d.wasmdb_loginWithToken, Dt = d.wasmdb_logout, Bt = d.wasmdb_new, qt = d.wasmdb_query, zt = d.wasmdb_queryText, Mt = d.wasmdb_queryWithParams, Ut = d.__wbg_jserror_free, Ct = d.jserror_message, Vt = d.host_log_message, Nt = d.host_alloc, Gt = d.host_free, Ht = d.host_realloc, Jt = d.test_alloc, $t = d.test_free, Xt = d.test_log_message, Yt = d.test_realloc, Kt = d.test_state_clear, Qt = d.test_state_get, Zt = d.test_state_iterator_free, te = d.test_state_iterator_next, ee = d.test_state_prefix, _e = d.test_state_range, ne = d.test_state_remove, re = d.test_state_set, oe = d.__wasm_bindgen_func_elem_17033, se = d.__wasm_bindgen_func_elem_17067, ae = d.__wbindgen_export, ie = d.__wbindgen_export2, de = d.__wbindgen_export3, ce = d.__wbindgen_export4, be = d.__wbindgen_add_to_stack_pointer, ge = Object.freeze(Object.defineProperty({
    __proto__: null,
    __wasm_bindgen_func_elem_17033: oe,
    __wasm_bindgen_func_elem_17067: se,
    ...
    wasmdb_commandWithParams: Pt,
    wasmdb_loginWithPassword: Ft,
    wasmdb_loginWithToken: Et,
    wasmdb_logout: Dt,
    wasmdb_new: Bt,
    wasmdb_query: qt,
    wasmdb_queryText: zt,
