import { c as h, l as s } from "./index-Da-94HbO.js";
import { C as c, H as u, D as p, a as m, R as f, b as _, c as w, d as k, F as v, e as D, S as P, f as R, g as I } from "./lspLanguageFeatures-DS_MWqPq.js";
import { h as b, i as H, j as y, t as U, k as T } from "./lspLanguageFeatures-DS_MWqPq.js";
const C = 120 * 1e3;
class A {
  constructor(o) {
  ...
  _getClient() {
    return this._lastUsedTime = Date.now(), this._client || (this._worker = h({ moduleId: "vs/language/css/cssWorker", createWorker: () => new Worker(new URL("/assets/css.worker-NZNbQL3P.js", import.meta.url), { type: "module" }), label: this._defaults.languageId, createData: { options: this._defaults.options, languageId: this._defaults.languageId } }), this._client = this._worker.getProxy()), this._client;
  }
  getLanguageServiceWorker(...o) {
    ...
    return this._getClient().then((a) => {
      ...
      if (this._worker) return this._worker.withSyncedResources(o);
    }).then((a) => e);
  }
}
function F(n) {
